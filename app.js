...
function sumArray(testArray){ //eslint-disable-line
  ...
  var messageSum = testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' was passed in as an array of numbers, and ' + sumOfArray + ' is their sum.';
  return [sumOfArray, messageSum];
}
...
function multiplyArray(testArray){ //eslint-disable-line
  ...
  var messageProduct ='The numbers ' + testArray [0] + ',' + testArray [1] + ',' + testArray [2] + ' have a product of ' + productOfArray + '.';
  return [productOfArray, messageProduct];
}
